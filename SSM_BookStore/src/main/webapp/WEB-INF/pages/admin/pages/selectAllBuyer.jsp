<%@ page import="com.pan.model.AdminBuyerMes" %>
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <%List<AdminBuyerMes> list = (List<AdminBuyerMes>) session.getAttribute("data");%>
                                    <%for (int i=0;i < list.size(); i++) {%>
                                    <%AdminBuyerMes adminBuyerMes = list.get(i);%>
                                    <tr>
                                        <td>
                                            <%=adminBuyerMes.getNameBuyer()%>
                                        </td>
                                        <td>
                                            <%=adminBuyerMes.getAdressBuyer()%>
                                        </td>
                                        <td>
