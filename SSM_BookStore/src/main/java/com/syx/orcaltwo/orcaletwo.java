...
public class orcaletwo {
    public static boolean isUser(userinfo userinfor) throws ClassNotFoundException, SQLException {
        ...
        try {
            ...
            String user = "u_2_4_2_1";// 用户名,系统默认的账户名
            String password = "W7h91-";// 你安装时选设置的密码
            con = DriverManager.getConnection(url, user, password);// 获取连接
            System.out.println("连接成功！");
            String sql = "select * from u_2_4_2_1.denglu_one";
            ...
            while (result.next()) {
                ...
                if (userinfor.getUsername().equals(usn) && userinfor.getPassword().equals(pas) && userinfor.getZhandian().equals(z) &&
                    ...
                    flag = true;
                    DataSourceUtil.setDataSource("datasource_oracle_u_2_4_2_1");
                }
            }
        }catch (Exception e)
        {
